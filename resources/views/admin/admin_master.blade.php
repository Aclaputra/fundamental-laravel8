                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="{{ asset('backend/assets/img/user/user_acla_hoodie.jpg')}}" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block">Acla Putra</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="{{ asset('backend/assets/img/user/user_acla_hoodie.jpg')}}" class="img-circle" alt="User Image" />
                        <div class="d-inline-block">
                          Acla Putra <small class="pt-1">acla@raharja.info</small>
                        </div>
                      </li>
